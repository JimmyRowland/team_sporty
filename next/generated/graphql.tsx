...
export type GetEventsForAllTeamQueryVariables = Exact<{ [key: string]: never; }>;


export type GetEventsForAllTeamQuery = (
  { __typename?: 'Query' }
  & { getTeams: Array<(
    { __typename?: 'GetTeamsResponse' }
    & Pick<GetTeamsResponse, 'isCoach' | 'isMember'>
    & { team: (
      { __typename?: 'Team' }
      & Pick<Team, 'name' | '_id'>
      & { events?: Maybe<Array<(
...
export const GetEventsForAllTeamDocument = gql`
    query GetEventsForAllTeam {
  getTeams {
    team {
      name
      _id
...
/**
 * __useGetEventsForAllTeamQuery__
 *
 * To run a query within a React component, call `useGetEventsForAllTeamQuery` and pass it any options that fit your needs.
 * When your component renders, `useGetEventsForAllTeamQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useGetEventsForAllTeamQuery({
 *   variables: {
 *   },
 * });
 */
export function useGetEventsForAllTeamQuery(baseOptions?: ApolloReactHooks.QueryHookOptions<GetEventsForAllTeamQuery, GetEventsForAllTeamQueryVariables>) {
        return ApolloReactHooks.useQuery<GetEventsForAllTeamQuery, GetEventsForAllTeamQueryVariables>(GetEventsForAllTeamDocument, baseOptions);
      }
export function useGetEventsForAllTeamLazyQuery(baseOptions?: ApolloReactHooks.LazyQueryHookOptions<GetEventsForAllTeamQuery, GetEventsForAllTeamQueryVariables>) {
          return ApolloReactHooks.useLazyQuery<GetEventsForAllTeamQuery, GetEventsForAllTeamQueryVariables>(GetEventsForAllTeamDocument, baseOptions);
        }
export type GetEventsForAllTeamQueryHookResult = ReturnType<typeof useGetEventsForAllTeamQuery>;
export type GetEventsForAllTeamLazyQueryHookResult = ReturnType<typeof useGetEventsForAllTeamLazyQuery>;
export type GetEventsForAllTeamQueryResult = ApolloReactCommon.QueryResult<GetEventsForAllTeamQuery, GetEventsForAllTeamQueryVariables>;
